...
namespace Medicus.Patient
{
    ...
    public partial class ImagePanelControl : UserControl
    {
        ...
        int sizeImg3;
        DXWindow mf;
       DossierPatient.ImageBitsPerPixel bpp;

        public DossierPatient.ViewSettings viewSettings;
        ...
        public ImagePanelControl()
        {
            ...
            viewSettings = DossierPatient.ViewSettings.ZoomToFit;
        ...
        private void ImagePanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (((bpp == DossierPatient.ImageBitsPerPixel.Eight) && (pix8.Count > 0)) ||
                 ((bpp == DossierPatient.ImageBitsPerPixel.Sixteen) && (pix16.Count > 0)) ||
                 ((bpp == DossierPatient.ImageBitsPerPixel.TwentyFour) && (pix24.Count > 0)))
            {
                if (viewSettings == DossierPatient.ViewSettings.Zoom1_1)
                {
                    SetScrollVisibility();
        ...
        private void panel_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (rightMouseDown == true)
            {
                ...
                UpdateMainForm();
                if (bpp == DossierPatient.ImageBitsPerPixel.Eight)
                {
                    ComputeLookUpTable8();
                    CreateImage8();
                }
                else if (bpp == DossierPatient.ImageBitsPerPixel.Sixteen)
                {
                    ComputeLookUpTable16();
                    CreateImage16();
                }
