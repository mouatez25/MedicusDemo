...
namespace Medicus.Patient
{
    public partial class WindowLevelGraphControl : UserControl
    {
        ...
        Medicus.Patient.Dicom.ImageBitsPerPixel iBpp;
        bool signedImage;
        ...
        public void SetWindowWidthCentre(int minVal, int maxVal, int widthVal, int centreVal,
            Medicus.Patient.Dicom.ImageBitsPerPixel bpp, bool sign)
        {
            winMin = minVal;
            winMax = maxVal;
            winWidth = widthVal;
        ...
        void DrawLines(Graphics g)
        {
            ...
            if (iBpp == Medicus.Patient.Dicom.ImageBitsPerPixel.Eight || iBpp == Medicus.Patient.Dicom.ImageBitsPerPixel.TwentyFour)
            {
