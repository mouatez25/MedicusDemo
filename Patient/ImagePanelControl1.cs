...
using static Medicus.Patient.Dicom;
//using static Medicus.Patient.DossierPatient;
...
namespace Medicus.Patient
{
    ...
    /// </summary>
    public partial class ImagePanelControl1 : UserControl
    {
        List<byte> pix8;
        List<ushort> pix16;
        List<byte> pix24;
        ...
        public void SetParameters(ref List<byte> arr, int wid, int hei, double windowWidth,
            double windowCentre, int samplesPerPixel, bool resetScroll, Dicom mainFrm)
        {
