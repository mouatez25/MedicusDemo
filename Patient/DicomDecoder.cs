...
namespace Medicus.Patient
{
    ...
    class DicomDecoder
    {
        ...
        const uint Patient_Name               = 0x00100010;
        const uint AcquisitionDate            = 0x00080022;
        const uint AcquisitionTime            = 0x00080032;
        ...
        public string NomPatient,AcquisitionDateString,AcquisitionTimeStirng;
        DicomDictionary dic;
    ...
    //   public Byte FileByte;
        ...
        public BinaryReader DicomFileNameBinaryReader
        {
            set
            {
                file = value;
            ...
            while (decodingTags)
            {
                ...
                switch (tag)
                {
                    ...
                    case (int)Patient_Name:
                        NomPatient = GetString(elementLength);
                         break;
                    case (int)AcquisitionDate:
                        AcquisitionDateString = GetString(elementLength);
                        break;
                    case (int)AcquisitionTime:
                        AcquisitionTimeStirng = GetString(elementLength);
                        break;
                    /************************************************/
